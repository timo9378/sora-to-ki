...
> 補記（2026-07-17）：其餘 useEffect 取資料的頁已比照處理 —— bookshelf / thinking /
> thinking/$id / watch / music 都補了 loader。`/watch/library` 與 `/activity` 刻意不做
> （前者全量 1,174 筆會產出 ~700KB HTML、後者是即時儀表板），理由見 ROADMAP.md 交接章節。
