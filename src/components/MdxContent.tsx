...
import { Annot, BarChart, CodeTabs, Math, Mention, Note, Ruby, Sketch, Spoiler, Tab, Tabs } from './mdx-blocks';
import './MdxContent.css';

// MDX 渲染可用的自訂 block。key = 文章裡寫的標籤名。
const MDX_BLOCKS = { Note, Annot, Spoiler, BarChart, Ruby, Mention, CodeTabs, Math, Tabs, Tab, Sketch };
